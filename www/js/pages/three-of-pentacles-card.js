...
const CARD_ID_PREFIX = '67-three-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('three-of-pentacles', lang) || (lang === 'th' ? '/th/cards/three-of-pentacles/' : '/cards/three-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('three-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/four-of-pentacles/index.html');
