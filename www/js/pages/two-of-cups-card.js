...
const CARD_ID_PREFIX = '38-two-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('two-of-cups', lang) || (lang === 'th' ? '/th/cards/two-of-cups/' : '/cards/two-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('two-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/three-of-cups/index.html');
