...
const CARD_ID_PREFIX = '53-three-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('three-of-swords', lang) || (lang === 'th' ? '/th/cards/three-of-swords/' : '/cards/three-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('three-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/four-of-swords/index.html');
