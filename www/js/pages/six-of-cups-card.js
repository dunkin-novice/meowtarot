...
const CARD_ID_PREFIX = '42-six-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('six-of-cups', lang) || (lang === 'th' ? '/th/cards/six-of-cups/' : '/cards/six-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('six-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/seven-of-cups/index.html');
