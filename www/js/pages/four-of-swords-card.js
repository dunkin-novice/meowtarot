...
const CARD_ID_PREFIX = '54-four-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('four-of-swords', lang) || (lang === 'th' ? '/th/cards/four-of-swords/' : '/cards/four-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('four-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/five-of-swords/index.html');
