...
const CARD_ID_PREFIX = '16-the-devil-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-devil', lang) || (lang === 'th' ? '/th/cards/the-devil/' : '/cards/the-devil/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-devil') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-tower/index.html');
