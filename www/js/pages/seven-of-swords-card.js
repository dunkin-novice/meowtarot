...
const CARD_ID_PREFIX = '57-seven-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('seven-of-swords', lang) || (lang === 'th' ? '/th/cards/seven-of-swords/' : '/cards/seven-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('seven-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/eight-of-swords/index.html');
