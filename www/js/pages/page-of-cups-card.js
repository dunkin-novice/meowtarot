...
const CARD_ID_PREFIX = '47-page-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('page-of-cups', lang) || (lang === 'th' ? '/th/cards/page-of-cups/' : '/cards/page-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('page-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/knight-of-cups/index.html');
