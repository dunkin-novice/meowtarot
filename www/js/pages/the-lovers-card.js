...
const CARD_ID_PREFIX = '07-the-lovers';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-lovers', lang) || (lang === 'th' ? '/th/cards/the-lovers/' : '/cards/the-lovers/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-lovers') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-chariot/index.html');
