...
const CARD_ID_PREFIX = '40-four-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('four-of-cups', lang) || (lang === 'th' ? '/th/cards/four-of-cups/' : '/cards/four-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('four-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/five-of-cups/index.html');
