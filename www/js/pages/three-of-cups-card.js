...
const CARD_ID_PREFIX = '39-three-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('three-of-cups', lang) || (lang === 'th' ? '/th/cards/three-of-cups/' : '/cards/three-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('three-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/four-of-cups/index.html');
