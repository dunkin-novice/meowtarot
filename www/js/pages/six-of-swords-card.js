...
const CARD_ID_PREFIX = '56-six-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('six-of-swords', lang) || (lang === 'th' ? '/th/cards/six-of-swords/' : '/cards/six-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('six-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/seven-of-swords/index.html');
