...
const CARD_ID_PREFIX = '23-ace-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ace-of-wands', lang) || (lang === 'th' ? '/th/cards/ace-of-wands/' : '/cards/ace-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ace-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/two-of-wands/index.html');
