...
const CARD_ID_PREFIX = '78-king-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('king-of-pentacles', lang) || (lang === 'th' ? '/th/cards/king-of-pentacles/' : '/cards/king-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('king-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-fool/index.html');
