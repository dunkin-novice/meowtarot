...
const CARD_ID_PREFIX = '19-the-moon-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-moon', lang) || (lang === 'th' ? '/th/cards/the-moon/' : '/cards/the-moon/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-moon') + 1] || '';
