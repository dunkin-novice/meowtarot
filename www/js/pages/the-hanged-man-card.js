...
const CARD_ID_PREFIX = '13-the-hanged';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-hanged-man', lang) || (lang === 'th' ? '/th/cards/the-hanged-man/' : '/cards/the-hanged-man/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-hanged-man') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/death/index.html');
