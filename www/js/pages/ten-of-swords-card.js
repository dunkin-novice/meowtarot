...
const CARD_ID_PREFIX = '60-ten-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ten-of-swords', lang) || (lang === 'th' ? '/th/cards/ten-of-swords/' : '/cards/ten-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ten-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/page-of-swords/index.html');
