...
const CARD_ID_PREFIX = '27-five-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('five-of-wands', lang) || (lang === 'th' ? '/th/cards/five-of-wands/' : '/cards/five-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('five-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/six-of-wands/index.html');
