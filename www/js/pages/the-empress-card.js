...
const CARD_ID_PREFIX = '04-the-empress';
...
function getPagePath(lang = 'en') {
  return lang === 'th' ? '/th/cards/the-empress/' : '/cards/the-empress/';
}
...
function render() {
  ...
  if (footerNext) footerNext.setAttribute('href', localize('/cards/the-emperor/index.html'));
