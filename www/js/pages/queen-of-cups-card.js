...
const CARD_ID_PREFIX = '49-queen-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('queen-of-cups', lang) || (lang === 'th' ? '/th/cards/queen-of-cups/' : '/cards/queen-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('queen-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/king-of-cups/index.html');
