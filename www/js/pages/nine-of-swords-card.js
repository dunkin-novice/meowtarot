...
const CARD_ID_PREFIX = '59-nine-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('nine-of-swords', lang) || (lang === 'th' ? '/th/cards/nine-of-swords/' : '/cards/nine-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('nine-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/ten-of-swords/index.html');
