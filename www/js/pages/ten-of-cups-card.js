...
const CARD_ID_PREFIX = '46-ten-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ten-of-cups', lang) || (lang === 'th' ? '/th/cards/ten-of-cups/' : '/cards/ten-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ten-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/page-of-cups/index.html');
