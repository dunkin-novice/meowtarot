...
const CARD_ID_PREFIX = '58-eight-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('eight-of-swords', lang) || (lang === 'th' ? '/th/cards/eight-of-swords/' : '/cards/eight-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('eight-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/nine-of-swords/index.html');
