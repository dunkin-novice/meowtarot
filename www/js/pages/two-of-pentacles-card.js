...
const CARD_ID_PREFIX = '66-two-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('two-of-pentacles', lang) || (lang === 'th' ? '/th/cards/two-of-pentacles/' : '/cards/two-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('two-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/three-of-pentacles/index.html');
