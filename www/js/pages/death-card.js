...
const CARD_ID_PREFIX = '14-death-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('death', lang) || (lang === 'th' ? '/th/cards/death/' : '/cards/death/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('death') + 1] || '';
