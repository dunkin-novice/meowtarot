...
const CARD_ID_PREFIX = '17-the-tower-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-tower', lang) || (lang === 'th' ? '/th/cards/the-tower/' : '/cards/the-tower/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-tower') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-star/index.html');
