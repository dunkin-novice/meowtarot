...
const CARD_ID_PREFIX = '69-five-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('five-of-pentacles', lang) || (lang === 'th' ? '/th/cards/five-of-pentacles/' : '/cards/five-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('five-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/six-of-pentacles/index.html');
