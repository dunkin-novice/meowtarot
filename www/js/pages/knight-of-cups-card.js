...
const CARD_ID_PREFIX = '48-knight-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('knight-of-cups', lang) || (lang === 'th' ? '/th/cards/knight-of-cups/' : '/cards/knight-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('knight-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/queen-of-cups/index.html');
