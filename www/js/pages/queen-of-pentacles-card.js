...
const CARD_ID_PREFIX = '77-queen-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('queen-of-pentacles', lang) || (lang === 'th' ? '/th/cards/queen-of-pentacles/' : '/cards/queen-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('queen-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/king-of-pentacles/index.html');
