...
const CARD_ID_PREFIX = '55-five-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('five-of-swords', lang) || (lang === 'th' ? '/th/cards/five-of-swords/' : '/cards/five-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('five-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/six-of-swords/index.html');
