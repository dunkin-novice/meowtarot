...
const CARD_ID_PREFIX = '72-eight-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('eight-of-pentacles', lang) || (lang === 'th' ? '/th/cards/eight-of-pentacles/' : '/cards/eight-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('eight-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/nine-of-pentacles/index.html');
