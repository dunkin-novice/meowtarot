...
const CARD_ID_PREFIX = '63-queen-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('queen-of-swords', lang) || (lang === 'th' ? '/th/cards/queen-of-swords/' : '/cards/queen-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('queen-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/king-of-swords/index.html');
