...
const CARD_ID_PREFIX = '11-wheel-of';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('wheel-of-fortune', lang) || (lang === 'th' ? '/th/cards/wheel-of-fortune/' : '/cards/wheel-of-fortune/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('wheel-of-fortune') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/justice/index.html');
