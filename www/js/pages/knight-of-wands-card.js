...
const CARD_ID_PREFIX = '34-knight-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('knight-of-wands', lang) || (lang === 'th' ? '/th/cards/knight-of-wands/' : '/cards/knight-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('knight-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/queen-of-wands/index.html');
