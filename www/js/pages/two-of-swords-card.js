...
const CARD_ID_PREFIX = '52-two-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('two-of-swords', lang) || (lang === 'th' ? '/th/cards/two-of-swords/' : '/cards/two-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('two-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/three-of-swords/index.html');
