...
const CARD_ID_PREFIX = '28-six-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('six-of-wands', lang) || (lang === 'th' ? '/th/cards/six-of-wands/' : '/cards/six-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('six-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/seven-of-wands/index.html');
