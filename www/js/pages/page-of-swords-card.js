...
const CARD_ID_PREFIX = '61-page-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('page-of-swords', lang) || (lang === 'th' ? '/th/cards/page-of-swords/' : '/cards/page-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('page-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/knight-of-swords/index.html');
