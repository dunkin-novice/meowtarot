...
const CARD_ID_PREFIX = '21-judgement-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('judgement', lang) || (lang === 'th' ? '/th/cards/judgement/' : '/cards/judgement/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('judgement') + 1] || '';
