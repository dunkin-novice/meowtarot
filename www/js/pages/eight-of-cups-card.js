...
const CARD_ID_PREFIX = '44-eight-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('eight-of-cups', lang) || (lang === 'th' ? '/th/cards/eight-of-cups/' : '/cards/eight-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('eight-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/nine-of-cups/index.html');
