...
const CARD_ID_PREFIX = '64-king-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('king-of-swords', lang) || (lang === 'th' ? '/th/cards/king-of-swords/' : '/cards/king-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('king-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/ace-of-pentacles/index.html');
