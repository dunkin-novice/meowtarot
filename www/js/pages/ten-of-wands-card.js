...
const CARD_ID_PREFIX = '32-ten-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ten-of-wands', lang) || (lang === 'th' ? '/th/cards/ten-of-wands/' : '/cards/ten-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ten-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/page-of-wands/index.html');
