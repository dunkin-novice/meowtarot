...
const CARD_ID_PREFIX = '50-king-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('king-of-cups', lang) || (lang === 'th' ? '/th/cards/king-of-cups/' : '/cards/king-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('king-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/ace-of-swords/index.html');
