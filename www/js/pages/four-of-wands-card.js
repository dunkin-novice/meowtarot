...
const CARD_ID_PREFIX = '26-four-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('four-of-wands', lang) || (lang === 'th' ? '/th/cards/four-of-wands/' : '/cards/four-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('four-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/five-of-wands/index.html');
