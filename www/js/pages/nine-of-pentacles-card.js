...
const CARD_ID_PREFIX = '73-nine-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('nine-of-pentacles', lang) || (lang === 'th' ? '/th/cards/nine-of-pentacles/' : '/cards/nine-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('nine-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/ten-of-pentacles/index.html');
