...
const CARD_ID_PREFIX = '75-page-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('page-of-pentacles', lang) || (lang === 'th' ? '/th/cards/page-of-pentacles/' : '/cards/page-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('page-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/knight-of-pentacles/index.html');
