...
const CARD_ID_PREFIX = '10-the-hermit';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-hermit', lang) || (lang === 'th' ? '/th/cards/the-hermit/' : '/cards/the-hermit/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-hermit') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/wheel-of-fortune/index.html');
