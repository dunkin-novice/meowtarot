...
const CARD_ID_PREFIX = '74-ten-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ten-of-pentacles', lang) || (lang === 'th' ? '/th/cards/ten-of-pentacles/' : '/cards/ten-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ten-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/page-of-pentacles/index.html');
