...
const CARD_ID_PREFIX = '41-five-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('five-of-cups', lang) || (lang === 'th' ? '/th/cards/five-of-cups/' : '/cards/five-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('five-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/six-of-cups/index.html');
