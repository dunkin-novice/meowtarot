...
const CARD_ID_PREFIX = '51-ace-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ace-of-swords', lang) || (lang === 'th' ? '/th/cards/ace-of-swords/' : '/cards/ace-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ace-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/two-of-swords/index.html');
