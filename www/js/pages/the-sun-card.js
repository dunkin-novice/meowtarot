...
const CARD_ID_PREFIX = '20-the-sun-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-sun', lang) || (lang === 'th' ? '/th/cards/the-sun/' : '/cards/the-sun/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-sun') + 1] || '';
