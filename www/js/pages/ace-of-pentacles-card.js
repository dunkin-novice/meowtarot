...
const CARD_ID_PREFIX = '65-ace-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ace-of-pentacles', lang) || (lang === 'th' ? '/th/cards/ace-of-pentacles/' : '/cards/ace-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ace-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/two-of-pentacles/index.html');
