...
const CARD_ID_PREFIX = '68-four-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('four-of-pentacles', lang) || (lang === 'th' ? '/th/cards/four-of-pentacles/' : '/cards/four-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('four-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/five-of-pentacles/index.html');
