...
const CARD_ID_PREFIX = '70-six-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('six-of-pentacles', lang) || (lang === 'th' ? '/th/cards/six-of-pentacles/' : '/cards/six-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('six-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/seven-of-pentacles/index.html');
