...
const CARD_ID_PREFIX = '18-the-star-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-star', lang) || (lang === 'th' ? '/th/cards/the-star/' : '/cards/the-star/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-star') + 1] || '';
