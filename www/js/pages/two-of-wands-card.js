...
const CARD_ID_PREFIX = '24-two-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('two-of-wands', lang) || (lang === 'th' ? '/th/cards/two-of-wands/' : '/cards/two-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('two-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/three-of-wands/index.html');
