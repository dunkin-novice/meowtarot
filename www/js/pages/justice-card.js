...
const CARD_ID_PREFIX = '12-justice-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('justice', lang) || (lang === 'th' ? '/th/cards/justice/' : '/cards/justice/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('justice') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-hanged-man/index.html');
