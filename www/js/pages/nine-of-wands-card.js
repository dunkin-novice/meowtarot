...
const CARD_ID_PREFIX = '31-nine-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('nine-of-wands', lang) || (lang === 'th' ? '/th/cards/nine-of-wands/' : '/cards/nine-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('nine-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/ten-of-wands/index.html');
