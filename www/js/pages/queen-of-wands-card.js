...
const CARD_ID_PREFIX = '35-queen-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('queen-of-wands', lang) || (lang === 'th' ? '/th/cards/queen-of-wands/' : '/cards/queen-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('queen-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/king-of-wands/index.html');
