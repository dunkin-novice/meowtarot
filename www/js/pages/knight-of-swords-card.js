...
const CARD_ID_PREFIX = '62-knight-of-swords';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('knight-of-swords', lang) || (lang === 'th' ? '/th/cards/knight-of-swords/' : '/cards/knight-of-swords/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('knight-of-swords') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/queen-of-swords/index.html');
