...
const CARD_ID_PREFIX = '43-seven-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('seven-of-cups', lang) || (lang === 'th' ? '/th/cards/seven-of-cups/' : '/cards/seven-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('seven-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/eight-of-cups/index.html');
