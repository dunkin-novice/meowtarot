...
const CARD_ID_PREFIX = '36-king-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('king-of-wands', lang) || (lang === 'th' ? '/th/cards/king-of-wands/' : '/cards/king-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('king-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/ace-of-cups/index.html');
