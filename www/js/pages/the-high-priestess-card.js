...
const CARD_ID_PREFIX = '03-the-high-priestess';
...
function getPagePath(lang = 'en') {
  return lang === 'th' ? '/th/cards/the-high-priestess/' : '/cards/the-high-priestess/';
}
...
function render() {
  ...
  if (footerNext) footerNext.setAttribute('href', localize('/cards/the-empress/index.html'));
