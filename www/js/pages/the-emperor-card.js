...
const CARD_ID_PREFIX = '05-the-emperor';
...
function getPagePath(lang = 'en') {
  return lang === 'th' ? '/th/cards/the-emperor/' : '/cards/the-emperor/';
}
...
function render() {
  ...
  if (footerNext) footerNext.setAttribute('href', localize('/cards/the-hierophant/index.html'));
