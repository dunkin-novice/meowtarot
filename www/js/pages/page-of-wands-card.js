...
const CARD_ID_PREFIX = '33-page-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('page-of-wands', lang) || (lang === 'th' ? '/th/cards/page-of-wands/' : '/cards/page-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('page-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/knight-of-wands/index.html');
