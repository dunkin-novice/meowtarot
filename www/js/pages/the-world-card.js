...
const CARD_ID_PREFIX = '22-the-world-upright';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-world', lang) || (lang === 'th' ? '/th/cards/the-world/' : '/cards/the-world/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-world') + 1] || '';
