...
const CARD_ID_PREFIX = '45-nine-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('nine-of-cups', lang) || (lang === 'th' ? '/th/cards/nine-of-cups/' : '/cards/nine-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('nine-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/ten-of-cups/index.html');
