...
const CARD_ID_PREFIX = '30-eight-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('eight-of-wands', lang) || (lang === 'th' ? '/th/cards/eight-of-wands/' : '/cards/eight-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('eight-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/nine-of-wands/index.html');
