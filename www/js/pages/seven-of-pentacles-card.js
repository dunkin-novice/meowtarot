...
const CARD_ID_PREFIX = '71-seven-of-pentacles';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('seven-of-pentacles', lang) || (lang === 'th' ? '/th/cards/seven-of-pentacles/' : '/cards/seven-of-pentacles/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('seven-of-pentacles') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/eight-of-pentacles/index.html');
