...
const CARD_ID_PREFIX = '29-seven-of-wands';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('seven-of-wands', lang) || (lang === 'th' ? '/th/cards/seven-of-wands/' : '/cards/seven-of-wands/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('seven-of-wands') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/eight-of-wands/index.html');
