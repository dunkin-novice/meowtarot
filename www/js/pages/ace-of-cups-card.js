...
const CARD_ID_PREFIX = '37-ace-of-cups';
...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('ace-of-cups', lang) || (lang === 'th' ? '/th/cards/ace-of-cups/' : '/cards/ace-of-cups/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('ace-of-cups') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/two-of-cups/index.html');
