...
export const translations = {
  en: {
    ...
    fullReadingStageDrawBody: 'Pick one face-down card. A fresh set appears after each draw for {position}.',
    fullReadingStageArrangeEyebrow: 'Review the spread',
    fullReadingStageArrangeTitle: 'Arrange your Celtic Cross order',
    fullReadingStageArrangeBody: 'Tap any two face-down cards to swap their positions. Position 1 becomes {firstPosition}, and position 10 becomes {lastPosition}.',
    fullReadingDeckReady: 'Draw',
    fullReadingDeckHint: 'Cards remain face-down until the reading.',
    fullReadingDrawnLabel: 'Cards drawn',
    fullReadingDrawnCount: '{current} of {total} cards locked in.',
  ...
  th: {
    ...
    fullReadingStageDrawBody: 'แตะเลือกไพ่คว่ำหน้า 1 ใบ แล้วระบบจะจัดชุดใหม่สำหรับตำแหน่ง {position}.',
    ...
    fullReadingDrawnCount: 'ล็อกแล้ว {current} จาก {total} ใบ',
