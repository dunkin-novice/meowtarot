...
export const translations = {
  en: {
    ...
    questionTitle: '3-Card Spread',
    questionDesc: 'Past · Present · Future',
    questionLead: 'Think of your question, pick a topic, then draw 3 cards for Past · Present · Future.',
    ...
    instruction: 'Focus on your question and pick 1 card.',
    contextDaily: '',
    ...
    continue: 'Continue',
    selectThreeHint: 'Select 1 card to continue.',
    past: 'Past',
    present: 'Present',
    future: 'Future',
  ...
  th: {
    ...
    languageLabel: 'ภาษา',
    landingIntro:
      'เลือกโหมดที่ต้องการ: ดูดวงรายวันคือไพ่ใบเดียวประจำวัน ดูดวงชีวิตใช้ไพ่ 3 ใบ อดีต / ปัจจุบัน / อนาคต ถามคำถามจะใช้ไพ่ 1 ใบตามหัวข้อที่เลือก',
    ...
    questionTitle: 'ไพ่ 3 ใบ',
    questionDesc: 'อดีต · ปัจจุบัน · อนาคต',
    questionLead: 'ตั้งใจคิดคำถาม เลือกหัวข้อ แล้วสุ่มไพ่ 3 ใบเพื่อดู อดีต · ปัจจุบัน · อนาคต',
    ...
    instruction: 'โฟกัสที่คำถามในใจ แล้วเลือกไพ่ 1 ใบ',
    contextDaily: '',
    ...
    continue: 'ดูคำทำนาย',
    selectThreeHint: 'เลือกไพ่ให้ครบ 1 ใบก่อนดำเนินการต่อ',
    past: 'อดีต',
    present: 'ปัจจุบัน',
    future: 'อนาคต',
