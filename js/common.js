...
export const translations = {
  en: {
    ...
    retentionSavePrompt: 'Save your journey and keep your streak forever',
    retentionSaveCta: 'Save Progress',
    retentionComingSoon: 'Account system coming later',
    ...
    fullReadingStageDrawBody: 'Pick 1 face-down card to lock in card {current} of {total} for {position}.',
  ...
  th: {
    ...
    retentionSavePrompt: 'บันทึกการเดินทางของคุณไว้ เพื่อรักษาสตรีคนี้ในอนาคต',
    retentionSaveCta: 'บันทึกความคืบหน้า',
    retentionComingSoon: 'ระบบบัญชีผู้ใช้กำลังมาเร็ว ๆ นี้',
