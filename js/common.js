...
export const translations = {
  en: {
    ...
    deckRewardGiftEyebrow: 'A deck, just for you',
    deckRewardGiftBody: '{deck} has been gifted to you. Tap to make it your active deck.',
  ...
  th: {
    ...
    deckRewardGiftEyebrow: 'สำรับพิเศษสำหรับคุณ',
    deckRewardGiftBody: 'มอบสำรับ {deck} ให้คุณแล้ว แตะเพื่อตั้งเป็นสำรับหลัก',
