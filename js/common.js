...
export const translations = {
  en: {
    ...
    landingIntro:
      'Pick a mode: Daily Reading gives a single card of the day. Overall Reading explores a 3-card Past / Present / Future story. Ask a Question offers a quick 1-card reply or a 3-card story in your chosen topic.',
    startReadingCta: 'Start your reading',
    homeDailyCta: 'Daily Reading',
    homeOverallCta: 'Overall Reading',
    ...
    questionLead: 'Think of a question in your mind. You can keep it in your heart or type it below.',
  ...
  th: {
    ...
    languageLabel: 'ภาษา',
    landingIntro:
      'เลือกโหมดที่ต้องการ: ดูดวงรายวันคือไพ่ใบเดียวประจำวัน ดูดวงภาพรวมใช้ไพ่ 3 ใบ อดีต / ปัจจุบัน / อนาคต ถามคำถามเลือกตอบเร็ว 1 ใบ หรือเล่าเรื่อง 3 ใบพร้อมหัวข้อที่สนใจ',
    startReadingCta: 'เริ่มดูดวง',
    homeDailyCta: 'ดูดวงรายวัน',
    homeOverallCta: 'ดูดวงภาพรวม',
    ...
    questionLead: 'ตั้งใจคิดคำถามในใจ จะเก็บไว้ในหัวใจหรือพิมพ์ไว้ด้านล่างก็ได้',
