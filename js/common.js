...
export const translations = {
  en: {
    ...
    questionLead: 'Bring one question close to your heart. Pick the area you want clarity on, then draw 3 cards for Past · Present · Future.',
    ...
    fullReadingStageDealBody: 'A shuffled circle of ten cards appears first. Then draw them one by one and set their final order before entering the reading.',
    fullReadingStageDrawEyebrow: 'Draw your spread',
    fullReadingStageDrawTitle: 'Draw card {current} of {total}',
    fullReadingStageDrawBody: 'Tap the deck to reveal the card for {position}.',
    fullReadingStageArrangeEyebrow: 'Review the spread',
    fullReadingStageArrangeTitle: 'Arrange your Celtic Cross order',
    fullReadingStageArrangeBody: 'Drag the cards into the final 1–10 order. Position 1 becomes {firstPosition}, and position 10 becomes {lastPosition}.',
    fullReadingDeckReady: 'Tap the deck to draw',
    fullReadingDeckHint: 'Each draw locks in one card from the shuffled pool.',
    fullReadingDrawnLabel: 'Cards drawn',
    fullReadingLatestCard: 'Latest draw',
    fullReadingArrangeHint: 'Drag by the handle to change which card belongs to each Celtic Cross position.',
  ...
  th: {
    ...
    questionLead: 'โอบคำถามไว้ในใจ เลือกเรื่องที่อยากได้ความชัดเจน แล้วสุ่มไพ่ 3 ใบเพื่อดู อดีต · ปัจจุบัน · อนาคต',
    ...
    fullReadingStageDealBody: 'ไพ่คว่ำหน้า 10 ใบจะถูกจัดวงไว้ก่อน จากนั้นค่อยหยิบทีละใบ แล้วจัดลำดับสุดท้ายก่อนเข้าสู่คำทำนาย.',
    fullReadingStageDrawEyebrow: 'หยิบไพ่ทีละใบ',
    fullReadingStageDrawTitle: 'หยิบไพ่ใบที่ {current} จาก {total}',
    fullReadingStageDrawBody: 'แตะกองไพ่เพื่อเปิดไพ่สำหรับตำแหน่ง {position}.',
    fullReadingStageArrangeEyebrow: 'ทบทวนสเปรด',
    fullReadingStageArrangeTitle: 'จัดลำดับเซลติกครอสของคุณ',
    fullReadingStageArrangeBody: 'ลากไพ่เพื่อเรียงลำดับสุดท้าย 1–10 โดยตำแหน่งที่ 1 จะเป็น {firstPosition} และตำแหน่งที่ 10 จะเป็น {lastPosition}.',
    fullReadingDeckReady: 'แตะกองไพ่เพื่อหยิบ',
    fullReadingDeckHint: 'ทุกครั้งที่หยิบจะล็อกไพ่ใบนั้นจากกองที่สับไว้แล้ว',
    fullReadingDrawnLabel: 'ไพ่ที่หยิบแล้ว',
    fullReadingLatestCard: 'ไพ่ใบล่าสุด',
    fullReadingArrangeHint: 'ลากที่ตัวจับเพื่อเปลี่ยนว่าไพ่ใบไหนจะอยู่ในตำแหน่งใดของเซลติกครอส',
