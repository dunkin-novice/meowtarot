...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-high-priestess', lang) || (lang === 'th' ? '/th/cards/the-high-priestess/' : '/cards/the-high-priestess/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-high-priestess') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-empress/');
