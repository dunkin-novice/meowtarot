...
function updateSeo(card) {
  ...
  const baseTitle = `${card.card_name_en || 'The High Priestess'} Tarot Meaning (${orientationLabel}) | MeowTarot`;
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: card.card_name_en || 'The High Priestess',
            item: pageUrl,
          },
        ],
      },
...
function render() {
  ...
  if (footerNext) footerNext.setAttribute('href', localize('/cards/the-empress/'));
  ...
  dom.cardNameHeading.textContent = card.card_name_en || 'The High Priestess';
