...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-empress', lang) || (lang === 'th' ? '/th/cards/the-empress/' : '/cards/the-empress/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-empress') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-emperor/');
