...
const PAGE_URL = 'https://www.meowtarot.com/cards/the-fool/';
...
function updateSeo(card) {
  ...
  if (dom.ogUrl) dom.ogUrl.setAttribute('content', PAGE_URL);
  ...
  if (dom.canonical) dom.canonical.setAttribute('href', PAGE_URL);
}
    ...
    '@graph': [
      {
        ...
        inLanguage: state.lang === 'th' ? 'th-TH' : 'en-US',
      },
      {
        '@type': 'BreadcrumbList',
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: 'Home',
            item: 'https://www.meowtarot.com/',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Tarot Card Meanings',
            item: 'https://www.meowtarot.com/tarot-card-meanings/',
          },
          {
            '@type': 'ListItem',
            position: 3,
...
async function init() {
  ...
  initShell({ currentLang: state.lang }, null, 'meanings', {
    onLangToggle(lang) {
      ...
      if (lang === 'th') url.searchParams.set('lang', 'th');
