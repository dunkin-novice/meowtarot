...
function getPagePath(lang = 'en') {
  return getCanonicalCardPath('the-emperor', lang) || (lang === 'th' ? '/th/cards/the-emperor/' : '/cards/the-emperor/');
}
...
function render() {
  ...
  const nextCanonicalSlug = CANONICAL_CARD_ORDER[CANONICAL_CARD_ORDER.indexOf('the-emperor') + 1] || '';
  ...
  if (footerNext) {
    const fallbackNext = localize('/cards/the-hierophant/');
